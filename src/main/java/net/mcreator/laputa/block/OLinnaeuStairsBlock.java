...
public class OLinnaeuStairsBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:o_linnaeu_stairs")
	public static final Block block = null;
	public OLinnaeuStairsBlock(LaputaModElements instance) {
		super(instance, 235);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("o_linnaeu_stairs");
		}
