...
public class SylphstoneStairsBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:sylphstone_stairs")
	public static final Block block = null;
	public SylphstoneStairsBlock(LaputaModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sylphstone_stairs");
		}
