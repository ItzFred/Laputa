...
public class LinneauStairsBlock extends LaputaModElements.ModElement {

	@ObjectHolder("laputa:linneau_stairs")
	public static final Block block = null;

	public LinneauStairsBlock(LaputaModElements instance) {
		super(instance, 39);
	...
	public static class CustomBlock extends StairsBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("linneau_stairs");
		}
