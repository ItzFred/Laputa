...
import net.mcreator.laputa.procedures.BubblodExplodeProcedure;
...
public class BubblodBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:bubblod")
	public static final Block block = null;
	public BubblodBlock(LaputaModElements instance) {
		super(instance, 273);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BubblodExplodeProcedure.executeProcedure($_dependencies);
			}
		}
