...
public class LinnaeuBrickWallBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:linnaeu_brick_wall")
	public static final Block block = null;
	public LinnaeuBrickWallBlock(LaputaModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("linnaeu_brick_wall");
		}
