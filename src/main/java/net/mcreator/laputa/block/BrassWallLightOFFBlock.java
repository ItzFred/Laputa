...
public class BrassWallLightOFFBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:brass_wall_light_off")
	public static final Block block = null;
	public BrassWallLightOFFBlock(LaputaModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("brass_wall_light_off");
		}
