...
public class PathosBricksBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:pathos_bricks")
	public static final Block block = null;
	public PathosBricksBlock(LaputaModElements instance) {
		super(instance, 194);
	}
