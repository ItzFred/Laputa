...
public class DepthSlabBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:depth_slab")
	public static final Block block = null;
	public DepthSlabBlock(LaputaModElements instance) {
		super(instance, 194);
	}
