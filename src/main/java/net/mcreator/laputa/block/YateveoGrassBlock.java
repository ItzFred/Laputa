...
public class YateveoGrassBlock extends LaputaModElements.ModElement {

	@ObjectHolder("laputa:yateveo_grass")
	public static final Block block = null;

	public YateveoGrassBlock(LaputaModElements instance) {
		super(instance, 272);
