...
public class LaputanBrick2WallBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:laputan_brick_2_wall")
	public static final Block block = null;
	public LaputanBrick2WallBlock(LaputaModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("laputan_brick_2_wall");
		}
