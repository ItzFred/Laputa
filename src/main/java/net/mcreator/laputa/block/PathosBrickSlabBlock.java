...
public class PathosBrickSlabBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:pathos_brick_slab")
	public static final Block block = null;
	public PathosBrickSlabBlock(LaputaModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pathos_brick_slab");
		}
