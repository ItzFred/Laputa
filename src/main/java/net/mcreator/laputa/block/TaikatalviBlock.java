...
public class TaikatalviBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:taikatalvi")
	public static final Block block = null;
	public TaikatalviBlock(LaputaModElements instance) {
		super(instance, 252);
	}
