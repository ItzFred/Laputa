...
public class LinnaeuTilesGrowthStairsBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:linnaeu_tiles_growth_stairs")
	public static final Block block = null;
	public LinnaeuTilesGrowthStairsBlock(LaputaModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("linnaeu_tiles_growth_stairs");
		}
