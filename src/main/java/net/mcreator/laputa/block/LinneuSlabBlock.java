...
public class LinneuSlabBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:linneu_slab")
	public static final Block block = null;
	public LinneuSlabBlock(LaputaModElements instance) {
		super(instance, 230);
	}
