...
public class LinnaeuBricksGrowthStairsBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:linnaeu_bricks_growth_stairs")
	public static final Block block = null;
	public LinnaeuBricksGrowthStairsBlock(LaputaModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("linnaeu_bricks_growth_stairs");
		}
