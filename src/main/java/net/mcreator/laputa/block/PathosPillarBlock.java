...
public class PathosPillarBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:pathos_pillar")
	public static final Block block = null;
	public PathosPillarBlock(LaputaModElements instance) {
		super(instance, 197);
	}
