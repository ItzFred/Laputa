...
public class SamsaraSlabBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:samsara_slab")
	public static final Block block = null;
	public SamsaraSlabBlock(LaputaModElements instance) {
		super(instance, 52);
	}
