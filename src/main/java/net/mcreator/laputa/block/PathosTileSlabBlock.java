...
public class PathosTileSlabBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:pathos_tile_slab")
	public static final Block block = null;
	public PathosTileSlabBlock(LaputaModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("pathos_tile_slab");
		}
