...
public class LaputanBrick2StairsBlock extends LaputaModElements.ModElement {

	@ObjectHolder("laputa:laputan_brick_2_stairs")
	public static final Block block = null;

	public LaputanBrick2StairsBlock(LaputaModElements instance) {
		super(instance, 12);
	...
	public static class CustomBlock extends StairsBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("laputan_brick_2_stairs");
		}
