...
public class OLinnaeuWallBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:o_linnaeu_wall")
	public static final Block block = null;
	public OLinnaeuWallBlock(LaputaModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("o_linnaeu_wall");
		}
