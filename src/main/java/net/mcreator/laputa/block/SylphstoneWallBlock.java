...
public class SylphstoneWallBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:sylphstone_wall")
	public static final Block block = null;
	public SylphstoneWallBlock(LaputaModElements instance) {
		super(instance, 264);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sylphstone_wall");
		}
