...
public class LinnaeuGrowthWallRBlock extends LaputaModElements.ModElement {
	@ObjectHolder("laputa:linnaeu_growth_wall_r")
	public static final Block block = null;
	public LinnaeuGrowthWallRBlock(LaputaModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.STONE).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("linnaeu_growth_wall_r");
		}
