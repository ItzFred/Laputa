...
package net.mcreator.laputa.gui;
...
import net.mcreator.laputa.procedures.AccessoryBagThisGUIIsOpenedProcedure;
import net.mcreator.laputa.procedures.Accessory3ProcedureProcedure;
import net.mcreator.laputa.procedures.Accessory2ProcedureProcedure;
import net.mcreator.laputa.procedures.Accessory1ProcedureProcedure;
...
public class AccessoryBagGui extends LaputaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public AccessoryBagGui(LaputaModElements instance) {
		super(instance, 171);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("accessory_bag"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				LaputaMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		...
		if (buttonID == 0) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Accessory1ProcedureProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Accessory2ProcedureProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Accessory3ProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
