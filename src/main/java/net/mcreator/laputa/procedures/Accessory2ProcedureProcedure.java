...
public class Accessory2ProcedureProcedure extends LaputaModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:accessories").toLowerCase(java.util.Locale.ENGLISH)))
				...
				}.getItemStack((int) (1))).getItem())) && (((entity.getCapability(LaputaModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new LaputaModVariables.PlayerVariables())).Accessory2).getItem() == (ItemStack.EMPTY).getItem()))) {
			{
